...
=======
	...
	{
		// Jeśli karta jest w ręce (HandContainer)
...
=======
	...
	public void RenderCardBack()
	{
		...
		// Ukrywamy wszystkie napisy i elementy graficzne przodu
		if (NameLabel != null) NameLabel.Visible = false;
		if (DescLabel != null) DescLabel.Visible = false;
		if (CostLabel != null) CostLabel.Visible = false;
		...
		if (Background != null)
		{
			Background.SelfModulate = new Color(0.05f, 0.05f, 0.05f); // Bardzo ciemny szary/czarny
		}

		if (Illustration != null)
		{
			// Tutaj możesz przypisać dedykowany obrazek tyłu karty jeśli go masz
			Illustration.Texture = GD.Load<Texture2D>("res://Assets/Cards/Cards/card_back.png");
			// Na razie zostawiamy pusty/czarny:
