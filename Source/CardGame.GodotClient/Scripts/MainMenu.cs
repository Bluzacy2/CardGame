...
namespace CardGame.GodotClient
{
    ...
    public partial class MainMenu : Control
    {
        ...
        {
            // Reference the Singleton (assuming AudioManager is also in CardGame.GodotClient namespace or global)
            // If AudioManager is in another namespace, add 'using' or fully qualify.
